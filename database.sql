...
("Couronnement de Napoléon", 5, "1804", "2 jours", "Assistez à un couronnement. Il s'en charge lui-même.", "Vue imprenable sur l'ambition. Retour à votre époque recommandé.", 10, 2, "http://localhost:3310/assets/events/EM/napoleon.png", 550),


/* Époque contemporaine */
("Inauguration de la Tour Eiffel", 6, "1899", "1 jour", "Découverte d'une structure métallique controversée.", "Tout le monde débat. Certains appellent ça de l'art, d'autres une erreur de calcul durable.", 20, 1, "http://localhost:3310/assets/events/EC/eiffel.png", 400),
...
("Woodstock, festival mythique de l'histoire", 6, "1969", "3 jours", "Vivez le festival le plus mythique de l'histoire.", "Boue, musique et foule compacte : expérience immersive garantie, hygiène optionnelle.", 25, 1, "http://localhost:3310/assets/events/EC/woodstock.png", 420),
...
("L'oeuf avant l'Abdou.", 7, "2222", "1 jour", "Question ancestrale. Réponse discutable.", "Un dinosaure de type PiouPiou apparaît.", 5, 1, "http://localhost:3310/assets/events/EA/pioupiou.png", 999);
